...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-warning">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">@gametopupshop</a>
        <!-- Sidebar Toggle-->
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="src/game.html">Game</a>
                                <a class="nav-link" href="src/pages/games/index.php">Data Games</a>
                            </nav>
                        </div>
