            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Transaksi Date</th>
                ...
                <tbody>
                    ...
                    foreach ($data as $row) { ?>
                        <tr>
                            ...
                            <td scoope="row"><?php echo $row['transaction_date']; ?></td>
                            <td>
                                <a href="edit.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                |
                                <a href="index.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus Transaksi ini?')"><button type="button" class="btn btn-danger">Hapus</button></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
